...
* GIF编辑器核心代码 - GIF生成部分
*
* - https://github.com/huzunjie/gif.js
*
* @author jnordberg 
*/
(function(c) {
    ...
    function(d, m, l, k) {
        ...
        e = function(d) {
            ...
            a.prototype.addFrame = function(a, d) {
                ...
                null == d && (d = {}),
                c = {},
                c.transparent = d.transparent||this.options.transparent;
            ...
            a.prototype.render = function() {
                ...
                this.imageParts = function(c) {
                    for (var b = function() {
                        ...
                        return b
                    }.apply(this, arguments), a = 0, e = b.length; a < e; ++a) d = b[a],
                    c.push(null);
                    return c
                }.call(this, []),
                a = this.spawnWorkers();
                for (var c = function() {
                    ...
                    return c
                }.apply(this, arguments), b = 0, e = c.length; b < e; ++b) d = c[b],
            ...
            a.prototype.finishRendering = function() {
                ...
                b = 0;
                for (var f = 0,
                j = this.imageParts.length; f < j; ++f) a = this.imageParts[f],
                ...
                for (var g = 0,l = this.imageParts.length; g < l; ++g) {
                    a = this.imageParts[g];
                    for (var c = 0,
                    i = a.data.length; c < i; ++c) h = a.data[c],
                    k = c,
                    e.set(h, d),
                ...
                try {
                    ...
                    window.Blob = function(resArr,typeObj){
                        var bb = new BB();
                        bb.append(e);
                        return bb.getBlob(type);
                    }
                }
                return this.emit('finished', m, e);
            },
            a.prototype.postMessageImageDataFixedChrome = function(work,data){
                try{
                    return work.postMessage(data);
                }catch(e){
                    if(e.message.indexOf('DATA_CLONE_ERR')>-1){
                        /* 解决部分浏览器将ImageData当做DOM导致无法postMessage的问题 */
                        var oldImageData=data.data, newImageData = [];
                        for (var i=0,oldDataItem;oldDataItem=oldImageData[i];i++) newImageData[i] = oldDataItem;
            ...
            a.prototype.renderNextFrame = function() {
                ...
                return this.nextFrame >= this.frames.length ? void 0 : (
                    ...
                    this.postMessageImageDataFixedChrome(b,a)
                    )
            },
            ...
            a.prototype.getImageData = function(b) {
                var a, w = this.options.width, h = this.options.height;
                null != this._canvas || (
                ...
                a.fillRect(0, 0, w, h);
                //drawImage(imgEl,sourceX,sourceY,sourceWidth, sourceHeight,destX, destY,destWidth, destHeight)
                //console.log('drawImage:', b, 0, 0, this.options.sourceWidth||w, this.options.sourceHeight||h, 0, 0, w, h),
                if(!this.options.usDrawBackground){
                    a.drawImage(b, 0, 0, this.options.sourceWidth||w, this.options.sourceHeight||h, 0, 0, w, h);
                }

                if(this.options.drawAfter){
                    a.save();
                    this.options.drawAfter.call(this, b, a);
                    a.restore();
                }
                return this.getContextData(a)
            },
    ...
    a.define('/browser.coffee',
    function(f, g, h, i) {
        var a, d, e, c, b;
        c = 'mozilla/5.0 (iphone; cpu iphone os 9_1 like mac os x) applewebkit/601.1.46 (khtml, like gecko) version/9.0 mobile/13b143 safari/601.1'
        e = 'win32'
    ...
    function(f, e, g, h) {
        ...
        a.prototype.emit = function(f) {
            ...
            if (! (typeof a == 'function')) if (c(a)) {
                ...
                e = a.slice();
                for (var d = 0,
                g = e.length; d < g; d++) e[d].apply(this, b);
                return ! 0
            } else return ! 1;
        ...
        a.prototype.addListener = function(a, b) {
            ...
            if (this._events || (this._events = {}), this.emit('newListener', a, b), !this._events[a]) this._events[a] = b;
                ...
                if (!this._events[a].warned) {
                    ...
                    e && e > 0 && this._events[a].length > e && (this._events[a].warned = !0, console.error('(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.', this._events[a].length), console.trace())
                }
